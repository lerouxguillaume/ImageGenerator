// parseTensorIndex: single-pass ONNX protobuf parser.
// Only this translation unit knows the protobuf wire format — all other
// modules work with the higher-level OnnxTensorIndex / OnnxSuffixIndex types.
